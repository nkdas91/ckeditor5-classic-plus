...
```bash
https://unpkg.com/ckeditor5-classic-plus@34.1.0/build/ckeditor.js
```
...
<!--Using CDN-->
<!--<script src="https://unpkg.com/ckeditor5-classic-plus@34.1.0/build/ckeditor.js"></script>-->
